...
- **Fase 7 (hardening de la instancia) hecha el 02/09/2026**, salvo dos tareas manuales del usuario: limpiar los DNS huérfanos + la security list de Oracle (T7.6) y rotar la `OPENAI_API_KEY` (T7.7).
...
## Pendiente / abierto
Fase 6, ya en orden de ejecución (detalle completo en `plan.md` §3 y §7). Hechas: **T6.1** README, **T6.2** dominio, **T6.3** archivo v1, **T6.4** nginx, **T6.7** vaciado del servidor.
