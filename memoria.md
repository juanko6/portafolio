...
## Pendiente / abierto
Fase 6, ya en orden de ejecución (detalle completo en `plan.md` §3 y §7). Hechas: **T6.1** README, **T6.2** dominio, **T6.3** archivo v1, **T6.4** nginx, **T6.5** publish.sh, **T6.7** vaciado del servidor.
